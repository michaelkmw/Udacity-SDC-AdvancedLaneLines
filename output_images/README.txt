...
The images are generated using the source images in test_images or camera_cal folder. They share the same names as the source images except with prefix to indicate the processing that has been applied to them
